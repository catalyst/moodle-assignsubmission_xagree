...
namespace assignsubmission_xagree\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        $detail = [
                    'agree' => 'privacy:metadata:agreement',
                  ];
        $collection->add_database_table('assignsubmission_xagree', $detail, 'privacy:metadata:xagree');
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $DB->delete_records('assignsubmission_xagree', ['cmid' => $requestdata->get_context()->instanceid]);
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $deletedata) {
        ...
        // Delete the records in the table.
        $DB->delete_records('assignsubmission_xagree', ['cmid' => $deletedata->get_context()->instanceid,
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        ...
        $params['cmid'] = $deletedata->get_context()->instanceid;
        $DB->delete_records_select('assignsubmission_xagree', "cmid = :cmid AND userid $sql", $params);
    }
}
